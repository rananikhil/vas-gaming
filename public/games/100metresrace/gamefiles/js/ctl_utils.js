...
function sizeHandler() {
	...
	var destH = CANVAS_HEIGHT * multiplier;
        ...
        if(s_oHealthBar !== null){
            s_oHealthBar.refreshButtonPos( s_iOffsetX,s_iOffsetY);
        }
        ...
        if(s_oPlayerProgress !== null){
            s_oPlayerProgress.refreshButtonPos( s_iOffsetX,s_iOffsetY);
        }
