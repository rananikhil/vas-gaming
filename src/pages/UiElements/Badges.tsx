...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | Odyssey (Gaming) Admin Dashboard Template"
        description="This is React.js Badges Dashboard page for Odyssey - React.js Tailwind CSS Admin Dashboard Template"
      />
